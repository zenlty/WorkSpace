...
# Assert
TARGET_OTA_ASSERT_DEVICE := ASUS_I005_1

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 60444672 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/asus/ASUS_I005_1
TARGET_KERNEL_CONFIG := ASUS_I005_1_defconfig
